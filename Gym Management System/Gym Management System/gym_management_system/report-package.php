...
function delete_record(package_id)
{
	this.document.frm.act.value="delete_package";
 ...
 <div class="container">
		...
		<div class="row">
		  <div class="col-lg-12">
			<form name="frm" action="lib/package.php" method="post">
			  <section class="panel">
				  ...
				  <table class="table table-striped table-advance table-hover" style="color:#000000">
				   <tbody>
					  ...
					  <tr>
						...
						<td><?=$data[package_fees]?></td>
						<td><?=$data[package_description]?></td>
						 <td>
						  <div class="btn-group">
						     <a href="package.php?package_id=<?php echo $data[package_id] ?>" class="btn btn-success">Edit</a>
                             <a class="delete-dialog btn btn-danger" data-id="<?php echo $data[package_id] ?>" data-toggle="modal" href="#myModal-2">Delete</a>
						  </div>
						  </td>
					  </tr>
					  <?php } ?>
			  ...
			  <input type="hidden" name="package_id" id="recordID" />
			 </form>
		  </div>
	  </div>
	</div>
