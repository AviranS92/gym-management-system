...
function check_login()
{
	...
	$SQL="SELECT * FROM subscriber WHERE subscriber_email = '$user_user' AND subscriber_password = '$user_password'";
	...
	if(mysqli_num_rows($rs))
	{
		...
		$_SESSION['user_details']['user_id'] = $_SESSION['user_details']['subscriber_id'];
		header("Location:../index.php");
	}
	else
	{
		header("Location:../subscriber-login.php?msg=Invalid User and Password.");
	}
}
####Function logout####
function logout()
{
	...
	header("Location:../subscriber-login.php?msg=Logout Successfullly.");
}
